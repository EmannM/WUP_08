...
Out of the two, LENGTH ~ HEADLEN has the better values (the points are the closest to the normal curve and there is the highest percent of mean model error explained of all the other models) and best fit. Therefore, head length is the best variable to use to predict the length of a bear. 
